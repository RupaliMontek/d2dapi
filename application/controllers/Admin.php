...
public function test(){
	...
	/******************************************************************Start aa_dfia_licence_details***************************************************************************************/
           ...
           $query = "SELECT aa_dfia_licence_details.*, ship_bill_summary.sbs_id, ship_bill_summary.iec,item_details.invoice_id,item_details.item_id FROM aa_dfia_licence_details LEFT JOIN item_details ON aa_dfia_licence_details.item_id = item_details.item_id LEFT JOIN invoice_summary ON invoice_summary.invoice_id = item_details.invoice_id LEFT JOIN ship_bill_summary ON invoice_summary.sbs_id = ship_bill_summary.sbs_id LIMIT 5";
	...
	/******************************************************************Start bill_of_entry_summary***************************************************************************************/
            ...
            $query1 = "SELECT  * FROM bill_of_entry_summary WHERE date(created_at) = CURRENT_DATE LIMIT 5";
	...
	/******************************************************************Start boe_delete_logs***************************************************************************************/
            ...
            $query_boe_delete_logs = "SELECT  * FROM boe_delete_logs  LIMIT 5";
	...
	/******************************************************************Start boe_delete_logs***************************************************************************************/
		...
		/******************************************************************Start bill_payment_details***************************************************************************************/
            ...
            $query_bill_payment_details = "SELECT  bill_payment_details.* , bill_of_entry_summary.boe_id,bill_of_entry_summary.iec_no FROM bill_payment_details  LEFT JOIN bill_of_entry_summary ON bill_of_entry_summary.boe_id = bill_payment_details.boe_id WHERE date(bill_payment_details.created_at) = CURRENT_DATE LIMIT 5";
...
/******************************************************************Start bill_bond_details***************************************************************************************/
            ...
            $query_bill_bond_details = "SELECT bill_bond_details.*, bill_of_entry_summary.boe_id,bill_of_entry_summary.iec_no FROM bill_bond_details LEFT JOIN bill_of_entry_summary ON bill_of_entry_summary.boe_id = bill_bond_details.boe_id WHERE date(bill_bond_details.created_at) = CURRENT_DATE LIMIT 5";
        ...
        foreach($result_bill_bond_details as $str_bill_bond_details){
                ...
                $sql_insert_bill_bond_details = "INSERT INTO `bill_bond_details` (`bond_details_id`, `bond_no`, `port`, `bond_cd`, `debt_amt`, `bg_amt`,`created_at`) VALUES('".$str_bill_bond_details['bond_details_id']."','".$str_bill_bond_details['bond_no']."','".$str_bill_bond_details['port']."','".$str_bill_bond_details['bond_cd']."','".$str_bill_bond_details['debt_amt']."','".$str_bill_bond_details['bg_amt']."','".$str_bill_bond_details['created_at']."')";   
                    $copy_bill_bond_details = $db1_bill_bond_details->query($sql_insert_bill_bond_details);
                    //  print_r($db1->last_query());
                }
...
/******************************************************************Start bill_container_details***************************************************************************************/
            ...
            $query_bill_container_details = "SELECT bill_container_details.*, bill_of_entry_summary.boe_id,bill_of_entry_summary.iec_no FROM bill_container_details LEFT JOIN bill_of_entry_summary ON bill_of_entry_summary.boe_id = bill_container_details.boe_id WHERE date(bill_container_details.created_at) = CURRENT_DATE LIMIT 5";
        ...
        foreach($result_bill_container_details as $str_bill_container_details){
                ...
                $copy_bill_container_details = $db1_bill_container_details->query($sql_insert_bill_container_details);
                    //  print_r($db1->last_query());
                }
...
/******************************************************************Start bill_licence_details***************************************************************************************/
        ...
        foreach($result_bill_licence_details as $str_bill_licence_details){
                ...
                $sql_insert_bill_licence_details = "INSERT INTO `bill_licence_details` (`duties_id`, `invsno`, `itemsn`, `lic_slno`, `lic_no`, `lic_date`,`code`,`port`,`debit_value`,`qty`,`uqc_lc_d`,`debit_duty`,`created_at`) VALUES('".$str_bill_licence_details['duties_id']."','".$str_bill_licence_details['invsno']."','".$str_bill_licence_details['itemsn']."','".$str_bill_licence_details['lic_slno']."','".$str_bill_licence_details['lic_no']."','".$str_bill_licence_details['lic_date']."','".$str_bill_licence_details['code']."','".$str_bill_licence_details['port']."','".$str_bill_licence_details['debit_value']."','".$str_bill_licence_details['qty']."','".$str_bill_licence_details['uqc_lc_d']."','".$str_bill_licence_details['debit_duty']."','".$str_bill_licence_details['created_at']."')";
                  ...
                  $copy_bill_licence_details = $db1_bill_licence_details->query($sql_insert_bill_licence_details);
                }
...
/******************************************************************Start boe_file_status***************************************************************************************/
            ...
            $query_boe_file_status = "SELECT * FROM public.boe_file_status WHERE date(created_at) = CURRENT_DATE LIMIT 5";
...
/******************************************************************Start bill_manifest_details***************************************************************************************/
            ...
            $query_bill_manifest_details = "SELECT bill_manifest_details.*, bill_of_entry_summary.boe_id,bill_of_entry_summary.iec_no FROM bill_manifest_details LEFT JOIN bill_of_entry_summary ON bill_of_entry_summary.boe_id = bill_manifest_details.boe_id  WHERE date(bill_manifest_details.created_at) = CURRENT_DATE LIMIT 5";
...
/******************************************************************Start challan_details***************************************************************************************/
            ...
            $query_challan_details = "SELECT challan_details.*,ship_bill_summary.sbs_id,ship_bill_summary.iec FROM challan_details LEFT JOIN ship_bill_summary ON ship_bill_summary.sbs_id=challan_details.sbs_id WHERE date(challan_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_drawback_details = $db1_drawback_details->query($sql_insert_drawback_details);    
	...
	/******************************************************************Start cb_file_status***************************************************************************************/
            ...
            $query_cb_file_status = "SELECT * FROM cb_file_status WHERE date(created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_cb_file_status = $db1_insert_cb_file_status->query($sql_insert_cb_file_status);    
	...
	/******************************************************************Start courier_bill_bond_details***************************************************************************************/
            ...
            $query_courier_bill_bond_details = "SELECT courier_bill_bond_details.*,cb_file_status.user_iec_no ,cb_file_status.cb_file_status_id FROM courier_bill_bond_details LEFT JOIN cb_file_status ON courier_bill_bond_details.courier_bill_of_entry_id = cb_file_status.cb_file_status_id WHERE date(courier_bill_bond_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_courier_bill_bond_details = $db1_courier_bill_bond_details->query($sql_insert_courier_bill_bond_details);    
	...
	/******************************************************************Start courier_bill_container_details***************************************************************************************/
            ...
            $query_courier_bill_container_details = "SELECT courier_bill_container_details.*,cb_file_status.user_iec_no ,cb_file_status.cb_file_status_id FROM courier_bill_container_details LEFT JOIN cb_file_status ON courier_bill_container_details.courier_bill_of_entry_id = cb_file_status.cb_file_status_id WHERE date(courier_bill_container_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_courier_bill_duty_details = $db1_courier_bill_duty_details->query($sql_insert_courier_bill_duty_details);    
	...
	/******************************************************************Start courier_bill_igm_details***************************************************************************************/
            ...
            $query_courier_bill_igm_details = "SELECT courier_bill_igm_details.*,cb_file_status.user_iec_no ,cb_file_status.cb_file_status_id FROM courier_bill_igm_details LEFT JOIN cb_file_status ON courier_bill_igm_details.courier_bill_of_entry_id = cb_file_status.cb_file_status_id WHERE date(courier_bill_igm_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_courier_bill_igm_details = $db1_insert_courier_bill_igm_details->query($sql_insert_courier_bill_igm_details);    
	...
	/******************************************************************Start courier_bill_invoice_details***************************************************************************************/
            ...
            $query_courier_bill_invoice_details = "SELECT courier_bill_invoice_details.*,cb_file_status.cb_file_status_id, cb_file_status.user_iec_no FROM courier_bill_invoice_details LEFT JOIN courier_bill_summary ON courier_bill_summary.courier_bill_of_entry_id=courier_bill_invoice_details.courier_bill_of_entry_id LEFT JOIN cb_file_status ON cb_file_status.cb_file_status_id=courier_bill_summary.cb_file_status_id";
...
$copy_insert_courier_bill_invoice_details = $db1_courier_bill_invoice_details->query($sql_insert_courier_bill_invoice_details);    
	...
	/******************************************************************Start courier_bill_items_details***************************************************************************************/
            ...
            $query_courier_bill_items_details = "SELECT courier_bill_items_details.*,cb_file_status.user_iec_no ,cb_file_status.cb_file_status_id FROM courier_bill_items_details LEFT JOIN cb_file_status ON courier_bill_items_details.courier_bill_of_entry_id = cb_file_status.cb_file_status_id WHERE date(courier_bill_items_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_courier_bill_items_details = $db1_insert_courier_bill_items_details->query($sql_insert_courier_bill_items_details);          
	...
	/******************************************************************Start courier_bill_manifest_details***************************************************************************************/
            ...
            $query_courier_bill_manifest_details = "SELECT courier_bill_manifest_details.*,cb_file_status.user_iec_no ,cb_file_status.cb_file_status_id FROM courier_bill_manifest_details LEFT JOIN cb_file_status ON courier_bill_manifest_details.courier_bill_of_entry_id = cb_file_status.cb_file_status_id WHERE date(courier_bill_manifest_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_courier_bill_procurment_details = $db1_insert_courier_bill_procurment_details->query($sql_insert_courier_bill_igm_details);    
	...
	/******************************************************************Start courier_bill_summary***************************************************************************************/
            ...
            $query_courier_bill_summary = "SELECT courier_bill_summary.*,cb_file_status.user_iec_no ,cb_file_status.cb_file_status_id FROM courier_bill_summary LEFT JOIN cb_file_status ON courier_bill_summary.cb_file_status_id =cb_file_status.cb_file_status_id WHERE date(courier_bill_summary.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_item_manufacturer_details = $db1_insert_item_manufacturer_details->query($sql_insert_item_manufacturer_details);    
	...
	/******************************************************************Start item_details***************************************************************************************/
            ...
            $query_item_details = "SELECT item_details.*,invoice_summary.invoice_id as invoiceid,invoice_summary.sbs_id,ship_bill_summary.iec,ship_bill_summary.sbs_id FROM item_details LEFT JOIN invoice_summary ON invoice_summary.invoice_id=item_details.invoice_id LEFT JOIN ship_bill_summary ON ship_bill_summary.sbs_id=invoice_summary.sbs_id WHERE date(item_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_rodtep_details = $db1_rodtep_details->query($sql_insert_rodtep_details);    
	...
	/******************************************************************Start rodtep_details***************************************************************************************/
		...
		/******************************************************************Start jobbing_details***************************************************************************************/
            ...
            $query_jobbing_details = "SELECT jobbing_details.*,ship_bill_summary.iec,ship_bill_summary.sbs_id FROM jobbing_details LEFT JOIN ship_bill_summary ON ship_bill_summary.sbs_id=jobbing_details.sbs_id WHERE date(jobbing_details.created_at) = CURRENT_DATE LIMIT 5";
...
$copy_insert_jobbing_details = $db1_insert_jobbing_details->query($sql_insert_jobbing_details);    
	...
	/******************************************************************Start ship_bill_summary***************************************************************************************/
            ...
            $query_ship_bill_summary = "SELECT * FROM ship_bill_summary WHERE date(created_at) = CURRENT_DATE LIMIT 5";
...
/************************************************Start duties_and_additional_detail***************************************************************************************/
	...
	/******************************************************************Start equipment_details***************************************************************************************/
            ...
            $query_equipment_details = "SELECT equipment_details.*,ship_bill_summary.sbs_id,ship_bill_summary.iec FROM equipment_details LEFT JOIN ship_bill_summary ON ship_bill_summary.sbs_id=equipment_details.sbs_id WHERE date(equipment_details.created_at) = CURRENT_DATE LIMIT 5";
